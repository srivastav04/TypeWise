        ...
        <div className="bg-black text-white min-h-screen flex flex-col">
            ...
            >
                ...
                <div className="flex space-x-6">
                    {['Stats', "Signout"].map((text, idx) => (
                        <Link
                            to={text === 'Stats' ? '/stats' : '/'}
                            key={idx}
                            className="text-lg font-semibold text-transparent bg-clip-text bg-gradient-to-r from-teal-300 via-purple-400 to-pink-500 hover:from-cyan-900 hover:via-fuchsia-900 hover:to-rose-900 transition duration-300"
                        >
                            {text}
                        </Link>
                    ))}
            ...
            >
                {/* Left */}
                <span className='font-bold text-md'>Srivastav (Web Developer)</span>

                {/* Center */}
                <span className='font-bold text-md'>© 2025 TypeWise</span>
            </motion.footer>
        </div>
    );
};
